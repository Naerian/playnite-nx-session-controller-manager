...
## 3. Tester (compatibilidad Gamepad Tester)

Los alias `SourceName = GamepadTester` y nombres 1.1 siguen activos. Si el tema solo comprueba `GamepadTester_518dc982-…`, añade también:
